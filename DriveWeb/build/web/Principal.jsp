        ...
        <nav class="navbar navbar-fixed-top" style="background-color: rgba(0,0,0,0.2);">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right" style="padding-top: 3px">
                    <li><a href="#" style="color: white; background-color: transparent; font-size: 20px"><span class="glyphicon glyphicon-user"></span> <%= conexion.Usuario %> - Cerrar Sesión  </a></li>                    
                </ul>
                ...
                <div class="col-sm-2 sidenav hidden-xs" style="text-align: center">
                    ...
                    <form action="crearCarpeta" method="POST">
                        <div class="form-group row">
                          <div class="col-xs-12">
                            <h2>Nombre Carpeta</h2>
                            <input class="form-control" type="text" name="carpeta" style="color: black; font-weight: bold;">
                          </div>
                        </div>
                        <ul class="nav nav-pills nav-stacked">
                            <button type="submit" class="btn btn-default">Crear Carpeta <span class="glyphicon glyphicon-folder-open"></span></button>
                        </ul>
                    </form>                    
                </div>        
                <div class="col-sm-6">
                    <h1>Carpetas En la Raiz</h1>                    
                    <%
                        if(null!= request.getAttribute("ObjetoCarpetas"))
                        {
                        out.print(request.getAttribute("ObjetoCarpetas"));
                        }
                    %>
                </div>                
            </div>                               
